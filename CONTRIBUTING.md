# snap plugin collector csvreader
...
* Whether your contribution is for a bug fix or a feature request, **create an [Issue](https://github.com/intelsdi-x/snap-plugin-collector-csvreader/issues)** and let us know what you are thinking.
...
$ git clone https://github.com/intelsdi-x/snap-plugin-collector-csvreader.git
    ```
